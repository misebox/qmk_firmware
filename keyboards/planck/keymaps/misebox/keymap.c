...
enum planck_layers { _QWERTY, _FULL, _SYMBOL, _MOVE, _TENFUNC, _SPECIAL, _KEYBOARD };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FULL] = LAYOUT_planck_grid(
        ...
        //  |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
              _______, _______, _______, _______, _______, _______, KC_BSPC,  KC_ENT, KC_RCTL, KC_RALT, KC_RGUI,    KANA
        //  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
    ),
    ...
    [_MOVE] = LAYOUT_planck_grid(
        ...
        //  |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
              _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_DEL, KC_HOME,  KC_END, KC_BSPC,ESC_EISU, XXXXXXX,
        //  |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|

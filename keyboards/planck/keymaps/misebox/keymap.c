...
//  |--------|--------|--------|--------|--------|-----------------|--------|--------|--------|--------|--------|
     LT(4,KC_HOME),KC_LGUI,LALT_T(KC_DEL),LT(3,KC_LANG2),MO(1),LSFT_T(KC_SPC),KC_LSFT,LT(2,KC_ENT),RCTL_T(KC_TAB),RALT_T(KC_LANG1),KC_APP,LT(5,KC_END)),
//  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
...
//  |--------|--------|--------|--------|--------|-----------------|--------|--------|--------|--------|--------|
      KC_TRNS,   KC_NO,   KC_NO,  MU_MOD,  MUV_DE,  MU_OFF,   MU_ON,  MUV_IN,  MU_MOD,   KC_NO,   KC_NO, KC_TRNS)
//  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
};

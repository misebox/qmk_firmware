...
//  |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
//  |L4/ Home|  LGUI  |  LALT  |L3/ Eisu|L1 / TAB|LSFT/SPC|RSFT/ BS|L2/ENTER|CTL/Kana|  RALT  |  RGUI  |L5 / END|
     LT(4,KC_HOME),KC_LGUI,KC_LALT,LT(3,KC_LANG2),LT(1,KC_TAB),LSFT_T(KC_SPC),RSFT_T(KC_BSPC),LT(2,KC_ENT),RCTL_T(KC_LANG1),KC_RALT,KC_RGUI,LT(5,KC_END)),
//  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
...
//  |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_P0, KC_PCMM, KC_PDOT, KC_PENT, MO(6)),
//  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
